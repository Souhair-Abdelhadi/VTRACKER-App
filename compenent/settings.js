    ...
    render(){
        ...
        <View style={styles.distance}>
            ...
            <View style={styles.button} >
                <Button  title='Change email ' color='#a6ddaf'
        ...
        <View style={styles.distance}>
            ...
            <View style={styles.button} >
                <Button  title='Change password ' color='#a6ddaf'
        ...
        <View style={styles.distance}>
            ...
            <View style={styles.button} >
                <Button  title='Change email and password ' color='#a6ddaf'  
